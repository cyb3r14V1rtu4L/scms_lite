        ...
        <div class="nav-tabs-navigation">
            <div class="nav-tabs-wrapper">
                <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
                    <li class="active"><a href="#cerradas" data-toggle="tab">PRESENTES (<?=$count_presentes?>)</a></li>
        ...
        <div id="my-tab-content" class="tab-content text-center">
            <div class="tab-pane active" id="cerradas">
                <p>
                    ...
                    <hr/>
                    <?= $this->element('Paper.xmf/pagination/casillas_presentes'); ?>
                </p>
                <div class="col-lg-12">
                  <div class="paginator">
                      <ul class="pagination">
